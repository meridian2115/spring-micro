package ru.micro.start.authservice.service.impl;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.security.crypto.password.PasswordEncoder;
import org.springframework.stereotype.Service;
import ru.micro.start.authservice.model.Role;
import ru.micro.start.authservice.model.Status;
import ru.micro.start.authservice.model.User;
import ru.micro.start.authservice.repository.RoleRepository;
import ru.micro.start.authservice.repository.UserRepository;
import ru.micro.start.authservice.service.AuthService;
import ru.micro.start.authservice.service.JwtService;
